...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 31 mai 2023 à 16:39
...
--
-- Structure de la table `t_d_motif_ticket`
--
...
--
-- Index pour la table `t_d_motif_ticket`
--
ALTER TABLE `t_d_motif_ticket`
...
--
-- AUTO_INCREMENT pour la table `t_d_motif_ticket`
--
ALTER TABLE `t_d_motif_ticket`
...
ALTER TABLE `t_d_ticket`
  ...
  ADD CONSTRAINT `t_d_ticket_ibfk_2` FOREIGN KEY (`Id_Motif`) REFERENCES `t_d_motif_ticket` (`Id_Motif`),
